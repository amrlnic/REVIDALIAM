...
public class DettaglioRichiestaVolontario extends AppCompatActivity {
    DBHelper db;
    RichiestaBean rb;
    OrdineBean ob;
    UtenteBean ub;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.volontario_activity_dettaglio_richiesta);
        ...
        Log.d("DetaglioRichiestaidOrdine",rb.getIdOrdine()+"");
        ...
        accetta=findViewById(R.id.accettarichiesta);
        accetta.setOnClickListener(goToAccetta);
    ...
    View.OnClickListener goToAccetta = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            String username=getIntent().getStringExtra("username");
            Log.d("UsernameReadyToAccetta",username);
            Intent intent = new Intent(v.getContext(), AccettaRichiestaVolontario.class);
            intent.putExtra("idRichiesta",ob.getIdOrdine());
