...
public class RichiestaAdapter extends BaseAdapter {
    ...
    public RichiestaAdapter(Context mContext, ArrayList<RichiestaBean> richiesta_list,ArrayList<Float> prezzi,ArrayList<String> nomi,ArrayList<String> supermercati) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        product.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(), DettaglioRichiestaVolontario.class);
