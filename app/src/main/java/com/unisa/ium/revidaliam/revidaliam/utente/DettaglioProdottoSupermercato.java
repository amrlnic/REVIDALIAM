...
public class DettaglioProdottoSupermercato extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(this, DettagliOrdine.class);
        Log.d("TAG", "Ritorniamo al dettaglio ordine dall'activity DettaglioProdottoSupermercato");

        i.putExtra("idorder", getIntent().getIntExtra("idorder", -1));
