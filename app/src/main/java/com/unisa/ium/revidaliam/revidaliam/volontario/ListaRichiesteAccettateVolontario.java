...
import com.unisa.ium.revidaliam.revidaliam.RichiestaAccettataAdapter;
...
public class ListaRichiesteAccettateVolontario extends AppCompatActivity {
    private DBHelper db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.volontario_activity_lista_richieste_accettate);
        listView = findViewById(R.id.mylistview);
        String username = getIntent().getStringExtra("username");
        db = new DBHelper(this.getApplicationContext());
        ArrayList<RichiestaBean> rb_list = db.retrieveRichiestaByUserContacts(username);
//        Log.d("rb_list",rb_list.get(0).getIdOrdine()+"");
        ...
        RichiestaAccettataAdapter richiesteAdapter = new RichiestaAccettataAdapter(this,rb_list,prezzi_list,nomi_list,supermercati_list);
